...
function handleCreateMapping() {
    ...
    const { bankName, updatedCount } = result;
    if (updatedCount > 0) {
        setStatus(`Mapping für ${bankName} erstellt. ${updatedCount} gespeicherte Umsätze aktualisiert.`, "info");
    }
    else {
        setStatus(`Mapping für ${bankName} erstellt.`, "info");
    }
}
