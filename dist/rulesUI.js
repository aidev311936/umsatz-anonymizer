...
function createNumberInput(labelText, value, onChange, options) {
    const wrapper = document.createElement("div");
    wrapper.className = "rule-field";
    const label = document.createElement("label");
    label.textContent = labelText;
...
function createMaskPercentInput(labelText, value, onChange) {
    const wrapper = document.createElement("div");
    wrapper.className = "rule-field";
    const label = document.createElement("label");
    label.textContent = labelText;
...
export function buildRulesUI(container) {
    container.innerHTML = "";
